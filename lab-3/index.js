...
var PersonalInfo = /** @class */ (function () {
    function PersonalInfo(fullName, address, phoneNumber, email, id, position, rank, salary) {
        this.id = id;
...
var stud1 = new Student(3, "Denys Zaruba", "Zelena street", "+380933030335", "deniszeruba@gmail.com", "front-end developer", "rank", 300);
var stud = new Student(4, "Denys Zaruba", "Zelena street", "+380933030335", "deniszeruba@gmail.com", "front-end developer", "rank", 300);
//Course factory
...
var MathProffesor = /** @class */ (function (_super) {
    ...
    function MathProffesor(id, fullName, address, phoneNumber, email) {
        return _super.call(this, id, fullName, address, phoneNumber, email, "DataBase Professor", "Professor", "4000") || this;
    }
...
var mathCourse = factoryCourse.create("DataBase");
...
var mathProf = profFact.create("DataBase", 4, "Andrew Anotil", "Chervona", "0971121365", "andrew.pr@gmail.com");
